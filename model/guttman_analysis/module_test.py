# MODULE_PATH = "/Users/Apple/Documents/Google-Sync/SWEN90014 Master Project/Project/swen90014-2019-rv-quoll/model/file_importing/__init__.py"
# MODULE_NAME = "file_importing"
...
def main():
    ...
    # print("/Users/Apple/Documents/Google-Sync/SWEN90014 Master Project/Project/swen90014-2019-rv-quoll/testdata/SampleAssessmentResult.xlsx")
    ...
    coor_item = retrieve_correlation_similarity(data, 'Accumulation')
    print(coor_item)
    print(get_0staddv_index(data))

    scorerate_accumulated = cal_scorerate_accumulated_matrix(data)
    print(scorerate_accumulated)
    print(get_0staddv_index(scorerate_accumulated))


    # TODO: 关于accumulation correlation的边界值问题， 我们还是应该考虑： 如果当前值本身就是 stdv是0，那么不比去看了。 下一步是计算范围内的stdv为零的， 如果这个是零， 也跳过。
